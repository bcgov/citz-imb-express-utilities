...
describe('getCurrentDateTime', () => {
  ...
  // Test case: Validate crossing over to the previous year in PST
  it('should handle date correctly when crossing over to the previous year (PST scenario)', () => {
    // Set system time to just after midnight UTC at the start of January, which corresponds to the evening of December 31st in PST
    jest.setSystemTime(new Date('2024-01-01T01:00:00Z'));

    const result = getCurrentDateTime();

    const expected = {
      formattedDateUTC: '2024-01-01',
      formattedTimeUTC: '01:00:00',
      formattedDatePacific: '2023-12-31', // December 31st due to -8 hours offset
      formattedTimePacific: '17:00:00', // 01:00 UTC - 8 hours
      pacificTimeZone: 'PST',
    };
