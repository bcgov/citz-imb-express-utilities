...
declare module 'express-serve-static-core' {
  interface Request {
    getZodValidatedParams: (schema: ZodSchema<unknown>) => object;
    getZodValidatedQuery: (schema: ZodSchema<unknown>) => object;
    getZodValidatedBody: (schema: ZodSchema<unknown>) => object;
  }
  interface Response {
